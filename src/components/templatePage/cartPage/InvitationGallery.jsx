...
const invitationData = [
  ...
  { title: "Modern Elegance", images: [Img2, Img3, Img1], colors: ["#EFEFEF", "#A8937B", "#2E2E2E"] },
  { title: "Classic Vibes", images: [Img3, Img1, Img2], colors: ["#FFF5E1", "#C0A68B", "#3D3D3D"] },
  { title: "Royal Touch", images: [Img1, Img2, Img3], colors: ["#EDEDED", "#D4AF37", "#4B4B4B"] }
];
...
const InvitationCard = ({ title, images, colors }) => {
  ...
  return (
    <Box textAlign="start">
      ...
      {/* Title */}
      <Box sx={{ fontSize: "18px", mt: "13px", color: "#63696c", fontWeight: "500" }}>
        {title}
      </Box>
