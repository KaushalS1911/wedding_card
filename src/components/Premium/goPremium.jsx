...
function GoPremium({premium, setPremium}) {
    ...
    return (
        ...
        <Dialog open={premium} onClose={handleClose} maxWidth="sm" fullWidth sx={{'& .MuiPaper-root':{borderRadius: 8}}}>
            <DialogContent sx={{ p: 3, position: 'relative'}}>
                ...
                <Button variant="contained" fullWidth sx={{backgroundColor: '#7F49D0', borderRadius: 2, p: 1}}>
                    Continue
                </Button>
                ...
                <Typography variant="body2" align="center" mt={1} sx={{color: '#63696C'}}>
                    Already a premium member? <span style={{color: '#22c55e', cursor: 'pointer'}} onClick={() => {
